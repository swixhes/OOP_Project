...
namespace TestProject
{
    ...
    public class AdminTests
    {
        ...
        {
            var admin = new Admin(1, "admin@a.com", "Test", "Admin", "+38(050)-1111111", "admin123");
            var original = new Coupon(1, "Old", CouponCategory.Food, DateTime.Now.AddDays(10), 10, 5, "Images/coupon.jpg", "Опис");
            var updated = new Coupon(1, "New", CouponCategory.Food, DateTime.Now.AddDays(10), 50, 5, "Images/coupon.jpg", "Опис");
        ...
        {
            var admin = new Admin(1, "admin@a.com", "Test", "Admin", "+38(050)-1111111", "admin123");
            var coupon = new Coupon(1, "ToDelete", CouponCategory.Food, DateTime.Now.AddDays(10), 50, 5, "Images/coupon.jpg", "Опис");
